...
export default function PostsAndVacancies() {
  return (
    <div className="flex-1 w-full bg-slate-50 min-h-screen pb-12">
      <Helmet>
        <title>Posts and Vacancies | RRB Technician CEN 02/2026</title>
        <meta name="description" content="Detailed information about Posts and Vacancies for RRB Technician Recruitment 2026." />
      </Helmet>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-6">
          <div className="bg-blue-800 p-6 sm:p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight mb-2">Posts and Vacancies</h1>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="prose max-w-none text-slate-700">
              <p>This section provides comprehensive details regarding Posts and Vacancies as outlined in the official RRB Technician CEN 02/2026 notification.</p>
