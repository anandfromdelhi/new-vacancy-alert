...
export const BPSC_TRE4_BOOK_LINKS = {
  ...
  LUCENT_GK: "https://www.amazon.in/s?k=Lucent+General+Knowledge+Hindi+English&tag=newvacancyale-21",
  BIHAR_GK: "https://www.amazon.in/s?k=Bihar+GK+KBC+Nano+Manish+Ranjan+Crown&tag=newvacancyale-21",
  LUCENT_HINDI: "https://www.amazon.in/s?k=Lucent+Samanya+Hindi&tag=newvacancyale-21",
  HARDEV_BAHRI_HINDI: "https://www.amazon.in/s?k=Hindi+Vyakaran+Hardev+Bahri&tag=newvacancyale-21",
  WREN_MARTIN_ENGLISH: "https://www.amazon.in/s?k=Wren+and+Martin+High+School+English+Grammar&tag=newvacancyale-21",
  SP_BAKSHI_ENGLISH: "https://www.amazon.in/s?k=Objective+General+English+SP+Bakshi&tag=newvacancyale-21",
  CDP_ARIHANT_KIRAN: "https://www.amazon.in/s?k=Child+Development+and+Pedagogy+Arihant+Kiran&tag=newvacancyale-21",
  RS_MATHS: "https://www.amazon.in/s?k=Quantitative+Aptitude+RS+Aggarwal&tag=newvacancyale-21",
  NCERT_SCIENCE: "https://www.amazon.in/s?k=NCERT+Science+Class+6+to+10&tag=newvacancyale-21",
  HC_VERMA_PHYSICS: "https://www.amazon.in/s?k=Concepts+of+Physics+HC+Verma&tag=newvacancyale-21",
  SPECTRUM_HISTORY: "https://www.amazon.in/s?k=Spectrum+Brief+History+of+Modern+India+Rajiv+Ahir&tag=newvacancyale-21",
  LAXMIKANTH_POLITY: "https://www.amazon.in/s?k=Indian+Polity+M+Laxmikanth&tag=newvacancyale-21",
  GC_LEONG_GEO: "https://www.amazon.in/s?k=Certificate+Physical+and+Human+Geography+GC+Leong&tag=newvacancyale-21",
  BPSC_TRE_PYQ: "https://www.amazon.in/s?k=BPSC+TRE+Previous+Year+Solved+Papers+Kiran+Disha&tag=newvacancyale-21"
};
