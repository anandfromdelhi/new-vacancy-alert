...
async function prerender() {
  ...
  const routes = new Set<string>([
    '/',
    '/articles',
    '/articles/salary-calculator',
    '/articles/ssc-exam-calendar',
    '/articles/rrb-exam-calendar-2026-27',
    '/articles/best-books-for-rrb-ntpc',
    '/articles/best-books-for-mpesb',
    '/articles/best-books-for-bihar-bsfc',
    '/articles/best-books-for-bpsc-tre-4',
    '/articles/bpsc-tre-4-best-books',
    '/articles/aiims-norcet-11-nursing-officer-2026/cutoff',
    '/articles/aiims-norcet-11-cutoff-marks',
    '/articles/ssc-cgl-master-guide',
    '/articles/ssc-cgl-notification-vacancies-trend',
    '/articles/ssc-cgl-posts-salary-pay-scale-hierarchy',
    '/articles/ssc-cgl-eligibility-physical-standards-pst-pet',
    '/articles/ssc-cgl-exam-pattern-syllabus-dest-typing',
    '/articles/ssc-cgl-cutoffs-post-preference-ranking-guide',
    '/articles/ssc-cgl-preparation-strategy-study-plan-books-mocks',
    '/articles/ssc-cgl-admit-card-selection-dv-checklist',
    '/about',
    '/contact',
    '/privacy-policy',
    '/rss-feed',
    ...
    '/rrb-ntpc-best-books',
    '/best-books-for-mpesb',
    '/best-books-for-mpesb-group-3',
    '/mpesb-best-books',
    '/best-books-for-bihar-bsfc',
    '/bihar-bsfc-best-books',
    '/best-books-for-bsfc',
    '/best-books-for-bpsc-tre-4',
    '/bpsc-tre-4-best-books',
    '/bpsc-tre-4-books',
