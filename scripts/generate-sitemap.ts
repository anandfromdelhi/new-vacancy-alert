...
async function generateSitemap() {
  ...
  const staticRoutes = [
    ...
    { url: '/articles/salary-calculator', priority: '0.8', changefreq: 'monthly' },
    { url: '/articles/ssc-exam-calendar', priority: '0.8', changefreq: 'monthly' },
    { url: '/articles/rrb-exam-calendar-2026-27', priority: '0.8', changefreq: 'monthly' },
    { url: '/articles/best-books-for-rrb-ntpc', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/best-books-for-mpesb', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/best-books-for-bihar-bsfc', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/aiims-norcet-11-nursing-officer-2026/cutoff', priority: '0.8', changefreq: 'monthly' },
    { url: '/about', priority: '0.5', changefreq: 'monthly' },
    { url: '/contact', priority: '0.5', changefreq: 'monthly' },
    { url: '/privacy-policy', priority: '0.3', changefreq: 'monthly' },
    { url: '/rss-feed', priority: '0.5', changefreq: 'monthly' },
    { url: '/articles/ssc-cgl-master-guide', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-notification-vacancies-trend', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-posts-salary-pay-scale-hierarchy', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-eligibility-physical-standards-pst-pet', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-exam-pattern-syllabus-dest-typing', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-cutoffs-post-preference-ranking-guide', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-preparation-strategy-study-plan-books-mocks', priority: '0.8', changefreq: 'weekly' },
    { url: '/articles/ssc-cgl-admit-card-selection-dv-checklist', priority: '0.8', changefreq: 'weekly' },
